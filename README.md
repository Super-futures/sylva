...
Modes
ModeCrossing durationRelationship to breathEase3.5–7s per crossingOne crossing per half breath cycleDeep1.5–3.5s per crossingOne crossing per quarter breath cycle
